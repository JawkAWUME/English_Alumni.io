...
English-Alumni/English_Alumni.html
@JawkAWUME
JawkAWUME First site
Latest commit 1ccadc2 4 hours ago
History
1 contributor
125 lines (117 sloc) 7.53 KB
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>English Access Alumni</title>
    <link href="https://fonts.googleapis.com/css2?family=Dosis:wght@600;800&display=swap" rel="stylesheet"> 
     <link rel="shortcut icon" href="PHOTO-2022-07-04-10-11-45.webp">
    <link rel="stylesheet" href="English_Alumni.css">
</head>
<body>
   <header>
     <nav>
...
<div class="Contain">
   <div class="Pick"><img src="brandon-erlinger-ford-NR1HLFP09Rw-unsplash.webp" alt=""></div>
   <div class="container">
    <h3>  WHAT WE DO </h3>
    <div style="border-color:#B31942;border-style:solid;width:10%;margin-top :6vh"></div>
    <p ><h4 style="line-height:4.9vh">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br> Ut elit tellus, luctus nec ullamcorper mattis, pulvinar <br> dapibus leo.</h4></p>
    <p ><h4 style="line-height:4.9vh">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br> Ut elit tellus, luctus nec ullamcorper mattis, pulvinar <br> dapibus leo.</h4></p>
    <div class="AU">About Us</div>
   </div>
 </div>
 <div class="Deg"></div>
 <div class="MB">
   <div><img src="com-1.webp" alt=""></div>
   <h1 style="font-weight:800;font-family:'Dosis',sans-serif;color:#0A3161;letter-spacing:0.1rem">MEMBERS BENEFITS</h1>
   
   <div class="Cont">
      <div class ="Stars"><img src="Screenshot 2022-08-01 at 15-40-45 Home.png" alt="">
          <h1 style="font-weight:800;font-family:'Dosis',sans-serif;color:#0A3161;letter-spacing:0.04rem"> TRAINING OPPORTUNITIES </h1></div>
      <div class ="Stars"><img src="Screenshot 2022-08-01 at 15-40-45 Home.png" alt="">
...
<div class="Phot">
   ...
   <div class="Carous">
      <div style="width:70%">
      <img src="cropped-PHOTO-2022-06-23-09-01-20.webp" alt=""height="340vh"width="360vh"style="position:relative;margin:4vh">
      <img src="brandon-erlinger-ford-NR1HLFP09Rw-unsplash.webp" alt=""height="340vh"width="360vh"style="position:relative;margin:4vh">
      <img src="brian-asare-18uJ53oQYYM-unsplash.webp" alt=""height="340vh"width="360vh"style="position:relative;margin:4vh">
